...
public abstract class BasePrefs {
    ...
    public boolean setintKeyValuePrefs(String key, int value) {
        if (!isValidTransaction()) return false;
        SharedPreferences prefs = getContext().getSharedPreferences(getPrefsName(),
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
    ...
    public boolean setLongKeyValuePrefs(String key, long value) {
        if (!isValidTransaction()) return false;
        SharedPreferences prefs = getContext().getSharedPreferences(getPrefsName(),
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
    ...
    public long getLongKeyValuePrefs(String key,long defaultValue) {
        if (!isValidTransaction()) return defaultValue;
        SharedPreferences prefs = getContext().getSharedPreferences(getPrefsName(),
                Context.MODE_PRIVATE);
    ...
    public boolean getBooleanKeyValuePrefs(String key, boolean defaultValue) {
        if (!isValidTransaction()) return defaultValue;
        SharedPreferences prefs = getContext().getSharedPreferences(getPrefsName(),
                Context.MODE_PRIVATE);
