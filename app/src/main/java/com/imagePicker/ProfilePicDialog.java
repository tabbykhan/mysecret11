...
public class ProfilePicDialog extends BaseDialogFragment {
    ...
    public void initializeComponent () {
        ...
        ll_layout = (LinearLayout) getView().findViewById(R.id.ll_layout);
        ll_camera_lay = (LinearLayout) getView().findViewById(R.id.ll_camera_lay);
        ll_camera_lay.setOnClickListener(this);
        ll_gallery_lay = (LinearLayout) getView().findViewById(R.id.ll_gallery_lay);
        ll_gallery_lay.setOnClickListener(this);
        ll_remove_lay = (LinearLayout) getView().findViewById(R.id.ll_remove_lay);
    ...
    public void setupDialog (Dialog dialog, int style) {
        ...
        //setup dialog_cancel_booking window param
        WindowManager.LayoutParams wlmp = dialog.getWindow().getAttributes();
        wlmp.windowAnimations = R.style.ProfilePicDialogStyle;
        ...
        public void onPermissionGranted (boolean isGranted, boolean withNeverAsk, String permission, int requestCode) {
            if (requestCode == PermissionHelperNew.STORAGE_PERMISSION_REQUEST_CODE) {
                ...
                if (isGranted) {
                    ...
                    //    displayErrorDialog("Please allow external storage permission to " + appName);
                }
            }
        }
    }
