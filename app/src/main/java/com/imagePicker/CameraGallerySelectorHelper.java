 ...
 * if (data != null) {
 * dialogChoosePicture.setImgUri(data.getTaxi_list());
 * }
 * }
...
public class CameraGallerySelectorHelper {
    ...
    /**
     * use for  open this dialog_cancel_booking for select image
     */
    public static int CHOOSE_IMAGE = 1;
    /**
     * use for open this dialog_cancel_booking for select video
     */
    ...
    /**
     * use for open dialog_cancel_booking type {@link #CHOOSE_IMAGE} or {@link #CHOOSE_VIDEO}
     */
