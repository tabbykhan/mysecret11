...
public class S3BucketHelper {
    ...
    public S3BucketHelper(Context context, String key, String secret, String region) {
        this.context = context;
        intializeAws(key, secret, region);
    }

    private void intializeAws(String key, String secret, String region) {
    ...
    public static class S3BucketFile extends BaseModel implements TransferListener {
        ...
        public void printLog(String message) {
            if (MyApplication.getInstance().isDebugBuild() && message != null)
                Log.e(TAG, message);
        }
