package com.app.ui.main.cricket.myteam.switchteam.adapter;
 ...
 */
public class SwitchTeamAdapter extends AppBaseRecycleAdapter {
    Context context;
    List<CustomerTeamModel> list;

    CustomerTeamModel selectedTeam;

    public SwitchTeamAdapter(Context context, List<CustomerTeamModel> list) {
