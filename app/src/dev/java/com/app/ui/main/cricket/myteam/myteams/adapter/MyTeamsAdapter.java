...
public class MyTeamsAdapter extends AppBaseRecycleAdapter {
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        public void setData(int position) {
            ...
            tv_tot_wk.setText(String.valueOf(customerTeamModel.getWicketkeapers().size()) );
            tv_tot_bat.setText(  String.valueOf(customerTeamModel.getBatsmans().size()));
            tv_tot_ar.setText( String.valueOf(customerTeamModel.getAllrounders().size()) );
            tv_tot_bow.setText( String.valueOf(customerTeamModel.getBowlers().size()));
