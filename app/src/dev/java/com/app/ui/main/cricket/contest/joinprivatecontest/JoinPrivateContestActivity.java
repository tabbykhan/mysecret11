package com.app.ui.main.cricket.contest.joinprivatecontest;
...
import com.app.ui.main.cricket.contest.joinprivatecontest.adapter.JoinPrivateContestAdapter;
...
public class JoinPrivateContestActivity extends AppBaseActivity implements MatchTimerListener {
    ...
    private void setupRecyclerView() {
        ...
        adapter = new JoinPrivateContestAdapter(this, contestWinnerBreakUpModel);
    ...
    private void callGetContestDetail() {
        ...
        getWebRequestHelper().getMatchPrivateContestDetail(getSlug(),match_unique_id, this);
    }
    ...
    private void handlePrivateContestDetail(WebRequest webRequest) {
        ...
        if (!responsePojo.isError() && responsePojo.getData()!=null && responsePojo.getData().size()>0) {
            ...
            try {
                Bundle bundle = new Bundle();
                bundle.putLong(DATA1, contestModel.getMatch_contest_id());
                bundle.putString(DATA2, JoinPrivateContestActivity.this.getClass().getSimpleName());
