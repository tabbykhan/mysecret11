package com.app.ui.main.cricket.myteam.myteams;
...
import com.app.ui.main.cricket.myteam.myteams.adapter.MyTeamsAdapter;
...
public class MyTeamsActivity extends AppBaseActivity implements MatchTimerListener {
    ...
    private void initializeRecyclerView() {
        adapter = new MyTeamsAdapter(this, customerTeamModels) {
            @Override
