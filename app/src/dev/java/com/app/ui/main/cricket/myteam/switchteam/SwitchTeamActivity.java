package com.app.ui.main.cricket.myteam.switchteam;
...
import com.app.ui.main.cricket.myteam.switchteam.adapter.SwitchTeamAdapter;
 ...
 */
public class SwitchTeamActivity extends AppBaseActivity implements MatchTimerListener {
    ...
    private void initializeRecyclerView() {
        adapter = new SwitchTeamAdapter(this, customerTeamModels) {
            @Override
    ...
    private void callSwitchTeam() {
        if (getMatchModel() != null) {
            ...
            getWebRequestHelper().customerSwitchTeam(requestModel, this);
