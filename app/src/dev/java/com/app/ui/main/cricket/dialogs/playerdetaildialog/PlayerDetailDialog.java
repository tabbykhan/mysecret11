package com.app.ui.main.cricket.dialogs.playerdetaildialog;
...
import com.app.ui.main.cricket.dialogs.playerdetaildialog.adapter.PlayerStatsAdapter;
...
public class PlayerDetailDialog extends AppBaseDialogFragment {
    ...
    public static PlayerDetailDialog getInstance(Bundle bundle) {
        PlayerDetailDialog messageDialog = new PlayerDetailDialog();
    ...
    private void initializeRecyclerView() {
        adapter = new PlayerStatsAdapter(getActivity(), playerStatsModels) {
            @Override
    ...
    private void getPlayerStats() {
        ...
        getWebRequestHelper().getSeriesByPlayerStatistics(getMatchModel().getMatch_id(),
