package com.app.ui.main.soccer.contest.makeyourcontest.adapter;
...
public class CreateSoccerContestActivityAdapter extends AppBaseRecycleAdapter {

    Context context;
    PrivateContestWinningBreakupResponseModel.WinnerBreakUpData contestWinnerBreakUpModel;

    public CreateSoccerContestActivityAdapter(Context context, PrivateContestWinningBreakupResponseModel.WinnerBreakUpData contestWinnerBreakUpModel) {
