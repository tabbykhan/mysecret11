package com.app.ui.main.cricket.dashboard.homenew.live.adapters;
 ...
 */
public class LiveMatchAdapter extends AppBaseRecycleAdapter {
    Context context;
    List<MatchModel> upcomingMatches;

    public LiveMatchAdapter(Context context, List<MatchModel> upcomingMatches) {
