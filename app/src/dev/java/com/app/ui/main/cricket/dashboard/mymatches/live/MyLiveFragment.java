package com.app.ui.main.cricket.dashboard.mymatches.live;
...
import com.app.ui.main.cricket.dashboard.mymatches.live.adapters.MyLiveAdapter;
 ...
 */
public class MyLiveFragment extends AppBaseFragment implements MatchTimerListener {
    ...
    private void initializeRecyclerView() {
        adapter = new MyLiveAdapter(getActivity(), MyApplication.getInstance().getMyLiveMatches()) {
            @Override
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                try {
                    ...
                    if (matchModel != null) {
                        ...
                        bundle.putString(DATA1, MyLiveFragment.this.getClass().getSimpleName());
    ...
    private void getCustoemrLiveMatches() {
        ...
        updateViewVisibitity(ll_no_item, View.GONE);
        updateViewVisibitity(tv_no_item, View.GONE);
        getWebRequestHelper().getCustomerLiveMatches(this);
    }
