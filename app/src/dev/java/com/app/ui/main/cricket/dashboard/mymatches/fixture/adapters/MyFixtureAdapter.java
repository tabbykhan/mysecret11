package com.app.ui.main.cricket.dashboard.mymatches.fixture.adapters;
 ...
 */
public class MyFixtureAdapter extends AppBaseRecycleAdapter {

    Context context;
    List<MatchModel> list;


    public MyFixtureAdapter(Context context, List<MatchModel> list) {
