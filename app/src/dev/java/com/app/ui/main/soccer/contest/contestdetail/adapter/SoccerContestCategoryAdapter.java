 ...
 */
public class SoccerContestCategoryAdapter extends AppBaseRecycleAdapter implements Filterable {
    Context context;
    List<ContestCategoryModel> list;

    public SoccerContestCategoryAdapter(Context context, List<ContestCategoryModel> list) {
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        SoccerContestAdapter contestAdapter;
        ...
        public void setData(int position) {
            ...
            if (contestCategoryModel != null) {
                ...
                contestAdapter = new SoccerContestAdapter(context, contestCategoryModel.getContests(),
