package com.app.ui.main.soccer.dialog.adapter;
 ...
 */
public class SoccerWinnerBreakupAdapter extends AppBaseRecycleAdapter {

    Context context;
    ContestWinnerBreakUpModel contestWinnerBreakUpModel;

    public SoccerWinnerBreakupAdapter(Context context, ContestWinnerBreakUpModel contestWinnerBreakUpModel) {
