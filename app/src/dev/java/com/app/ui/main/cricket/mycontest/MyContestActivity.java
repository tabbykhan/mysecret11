...
import com.app.ui.main.cricket.mycontest.adapter.MyContestCategoryAdapter;
...
public class MyContestActivity extends AppBaseActivity implements MatchTimerListener {
    ...
    private void initializeRecyclerView() {
        adapter = new MyContestCategoryAdapter(this, contestCategoryModels) {
            @Override
            ...
            @Override
            public MatchModel getMatchModel() {
                return MyContestActivity.this.getMatchModel();
            }
        };
    ...
    private void getCustomerMatchContest() {
        if (getMatchModel() != null) {
            ...
            getWebRequestHelper().getCustomerMatchContest(getMatchModel().getId(),
    ...
    public void onWebRequestResponse(WebRequest webRequest) {
        ...
        switch (webRequest.getWebRequestId()) {
            case ID_GET_CUSTOMER_MATCH_CONTEST:
