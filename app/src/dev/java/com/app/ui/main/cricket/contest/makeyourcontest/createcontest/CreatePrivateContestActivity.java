...
public class CreatePrivateContestActivity extends AppBaseActivity implements MatchTimerListener {
    ...
    private void setupRecyclerView(PrivateContestWinningBreakupResponseModel.WinnerBreakUpData contestWinnerBreakUpModel) {
        ...
        adapter = new CreateContestActivityAdapter(this, contestWinnerBreakUpModel);
    ...
    private void getPrivateContestWinningBreakUp() {
        ...
        getWebRequestHelper().getPrivateContestWinningBreakUp(getContestSize(),
    ...
    public void onWebRequestResponse(WebRequest webRequest) {
        ...
        switch (webRequest.getWebRequestId()) {
            case ID_GET_PRIVATE_CONTEST_WINNING_BREAKUP:
