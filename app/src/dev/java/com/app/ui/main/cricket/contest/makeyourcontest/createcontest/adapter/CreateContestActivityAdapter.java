package com.app.ui.main.cricket.contest.makeyourcontest.createcontest.adapter;
...
public class CreateContestActivityAdapter extends AppBaseRecycleAdapter {

    Context context;
    PrivateContestWinningBreakupResponseModel.WinnerBreakUpData contestWinnerBreakUpModel;

    public CreateContestActivityAdapter(Context context, PrivateContestWinningBreakupResponseModel.WinnerBreakUpData contestWinnerBreakUpModel) {
