 ...
 */
public class PracticeFragment extends AppBaseFragment {
        ...
        new ItemClickSupport(recycler_view) {
            ...
            public void onChildItemClicked(RecyclerView recyclerView, int parentPosition, int childPosition, View v) {
                switch (v.getId()) {
                    case R.id.tv_join: {
                        try {
                            ContestModel contestModel = PracticeFragment.this.contestCategoryModels.get(parentPosition).getContests().get(childPosition);
                    ...
                    default: {
                        try {
                            ...
                            Bundle bundle = new Bundle();
                            bundle.putLong(DATA1, contestModel.getMatch_contest_id());
                            bundle.putString(DATA2, PracticeFragment.this.getClass().getSimpleName());
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                switch (v.getId()) {
                    case R.id.tv_view_more: {
                        try {
                            long id = PracticeFragment.this.contestCategoryModels.get(position).getId();
                            if (id == viewMoreCatId) {
                                viewMoreCatId = -1;
                                viewMoreCatIdPos = -1;
