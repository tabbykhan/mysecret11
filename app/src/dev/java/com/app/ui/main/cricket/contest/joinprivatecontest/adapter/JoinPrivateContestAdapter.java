package com.app.ui.main.cricket.contest.joinprivatecontest.adapter;
...
public class JoinPrivateContestAdapter extends AppBaseRecycleAdapter {

    Context context;
    ContestWinnerBreakUpModel contestWinnerBreakUpModel;

    public JoinPrivateContestAdapter(Context context, ContestWinnerBreakUpModel contestWinnerBreakUpModel) {
