package com.app.ui.main.soccer.team.chooseteam.adapter;
 ...
 */
public class ChooseSoccerTeamAdapter extends AppBaseRecycleAdapter {
    Context context;
    ...
    public ChooseSoccerTeamAdapter(Context context, List<CustomerTeamModel> list) {
    ...
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_choose_soccer_team_adapter));
    }
