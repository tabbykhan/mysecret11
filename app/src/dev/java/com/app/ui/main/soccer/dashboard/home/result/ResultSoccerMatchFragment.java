...
import com.app.ui.main.soccer.dashboard.home.result.adapter.ResultSoccerMatchAdapter;
 ...
 */
public class ResultSoccerMatchFragment extends AppBaseFragment {

    private ResultSoccerMatchAdapter adapter;
    ...
    private void initializeRecyclerView() {
        adapter = new ResultSoccerMatchAdapter(getActivity(), MyApplication.getInstance().getPastMatches()) {
            @Override
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                try {
                    ...
                    if (matchModel != null) {
                        ...
                        bundle.putString(DATA1, ResultSoccerMatchFragment.this.getClass().getSimpleName());
    ...
    private void getUpcomingMatches() {
        ...
        updateViewVisibitity(tv_no_item, View.GONE);
        getWebRequestHelper().getUpcomingSoccerMatches("R", this);
    }
