...
public class ShareSoccerPrivateContestDialog extends AppBaseDialogFragment implements MatchTimerListener {
    ...
    public static ShareSoccerPrivateContestDialog getInstance(Bundle bundle) {
        ShareSoccerPrivateContestDialog playerEventsDialog = new ShareSoccerPrivateContestDialog();
        if (bundle != null)
    ...
    private void callShareTeam() {
        ...
        getWebRequestHelper().shareSoccerContest(getSlugName(), this);
    }
