package com.app.ui.main.soccer.dashboard.home.live;
...
import com.app.ui.main.soccer.dashboard.home.live.adapter.LiveSoccerMatchAdapter;
 ...
 */
public class LiveSocerFragment extends AppBaseFragment {
    private LiveSoccerMatchAdapter adapter;
    ...
    private void initializeRecyclerView() {
        adapter = new LiveSoccerMatchAdapter(getActivity(), MyApplication.getInstance().getLiveMatches()) {
            @Override
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                try {
                    ...
                    if (matchModel != null) {
                        ...
                        bundle.putString(DATA1, LiveSocerFragment.this.getClass().getSimpleName());
    ...
    private void getUpcomingMatches() {
        ...
        updateViewVisibitity(tv_no_item, View.GONE);
        getWebRequestHelper().getUpcomingSoccerMatches("L", this);
    }
