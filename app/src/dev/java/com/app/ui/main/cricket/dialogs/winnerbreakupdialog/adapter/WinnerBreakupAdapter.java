package com.app.ui.main.cricket.dialogs.winnerbreakupdialog.adapter;
...
public class WinnerBreakupAdapter extends AppBaseRecycleAdapter {
    ...
    public WinnerBreakupAdapter(Context context, ContestWinnerBreakUpModel contestWinnerBreakUpModel) {
