...
import com.app.ui.main.soccer.team.createteam.adapter.ChooseSoccerCaptionAdapter;
...
public class ChooseSoccerCaptionActivity extends AppBaseActivity implements MatchTimerListener {
    ...
    ChooseSoccerCaptionAdapter adapter;
            ...
            if (currentSortBy != null) {
                ...
                switch (currentSortBy.getId()) {
                    ...
                    case R.id.iv_sort_points_vc: {
                        if (currentSortType == 1) {
                            return Float.compare(Float.parseFloat(player2.getViceCaptionSelected_byText()), Float.parseFloat(player1.getViceCaptionSelected_byText()));
                        } else {
                            return Float.compare(Float.parseFloat(player1.getViceCaptionSelected_byText()), Float.parseFloat(player2.getViceCaptionSelected_byText()));
                        }
                    }
                }
            }
    ...
    public CustomerTeamModel getCustomerTeam() {
        ...
        if (extras != null) {
            ...
            if (isValidString(string)) {
                Log.d("bundle","--"+new Gson().fromJson(string, CustomerTeamModel.class));
    ...
    public int getLayoutResourceId() {
        return R.layout.activity_choose_soccer_caption;
    }
    ...
    public void initializeComponent() {
        ...
        selectedPlayers.addAll(customerExistTeam.getGoalkeepers());
        selectedPlayers.addAll(customerExistTeam.getDefenders());
        selectedPlayers.addAll(customerExistTeam.getMidfielders());
        selectedPlayers.addAll(customerExistTeam.getForwards());
    ...
    private void initializeRecyclerView() {
        ...
        adapter = new ChooseSoccerCaptionAdapter(selectedPlayers) {
            ...
            public String getPlayerTypeName(long team_id) {
                ...
                String correctColor = "#" + Integer.toHexString(ContextCompat.getColor(ChooseSoccerCaptionActivity.this, R.color.colorWhite)).substring(2);
                String correctColor2 = "#" + Integer.toHexString(ContextCompat.getColor(ChooseSoccerCaptionActivity.this, R.color.colorWhite)).substring(2);
            ...
            public String getPlayerTypeShortName(int playerType) {
                return ChooseSoccerCaptionActivity.this.getPlayerTypeShortName(playerType);
            }
    ...
    private void setupCaptionViceCaptionHeader() {
        ...
        if (captionModel == null) {
            ...
            loadImage(ChooseSoccerCaptionActivity.this, iv_caption_image, null, captionModel.getImage(), R.drawable.no_image);
        ...
        if (vccaptionModel == null) {
            ...
            loadImage(ChooseSoccerCaptionActivity.this, iv_vc_caption_image, null, vccaptionModel.getImage(), R.drawable.no_image);
    ...
    private void callSaveTeam() {
        if (getMatchModel() != null && getUserModel() != null) {
            ...
            if (getCustomerTeamId() == -1) {
                ...
                requestModel.user_id=String.valueOf(getUserModel().getId());
                ...
                for (int i = 0; i < selectedPlayers.size(); i++) {
                    ...
                    selectedPlayers.get(i).setBat_type("");
                    selectedPlayers.get(i).setBowl_type("");
                }

                requestModel.player_json.clear();
                requestModel.player_json.addAll(selectedPlayers);
                Log.d("posiotn", "--" +requestModel.player_json);
                for (int i=0;i<requestModel.player_json.size();i++){
                    Log.d("posiotn", "--" +new Gson().toJson(requestModel.player_json.get(i)));
                }
                if (MyApplication.getInstance().isIs_5_player_match()) {
                    getWebRequestHelper().createfivePlayerTeam(requestModel, this);
                } else {
                    getWebRequestHelper().createSoccerCustomerTeam(requestModel, this);
                }
                ...
                requestModel.player_json.clear();
                requestModel.player_json.addAll(selectedPlayers);
                getWebRequestHelper().updateCustomerSoccerTeam(requestModel, this);
            }
    ...
    public void onWebRequestResponse(WebRequest webRequest) {
        ...
        switch (webRequest.getWebRequestId()) {
            case ID_CREATE_SOCCER_CUSTOMER_TEAM:
                handleCreateCustomerTeamResponse(webRequest);
                break;
            case ID_UPDATE_CUSTOMER_SOCCER_TEAM:
