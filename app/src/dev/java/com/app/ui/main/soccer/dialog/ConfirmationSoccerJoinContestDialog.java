...
public class ConfirmationSoccerJoinContestDialog extends AppBaseDialogFragment {
    ...
    public static ConfirmationSoccerJoinContestDialog getInstance(Bundle bundle) {
        ConfirmationSoccerJoinContestDialog messageDialog = new ConfirmationSoccerJoinContestDialog();
    ...
    private void updateBottomMessage() {
        ...
        if (userModel != null && userModel.getSettings() != null) {
            ...
            tv_bottom_message.setText("By joining this contest, you accept My Secret 11 T & C and" +
                    " confirm that you are not a resident of Assam, Odissa, Telangana, Nagaland or Sikkim.");
        } else {
    ...
    private void callPreJoinContest() {
        if (getMatchModel() != null) {
            ...
            getWebRequestHelper().customerSoccerPreJoinContest(requestModel, this);
        }
    }
    ...
    public void onWebRequestResponse(WebRequest webRequest) {
        ...
        switch (webRequest.getWebRequestId()) {
            case ID_CUSTOMER_SOCCER_PRE_JOIN_CONTEST:
