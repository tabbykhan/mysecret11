...
public class SoccerSliderFragment extends AppBaseFragment {
    ...
    private void setupViewPager() {
        ...
        for (SliderModel sliderModel : sliderModels) {
            SoccerSliderItemFragment sliderItemFragment = new SoccerSliderItemFragment();
    ...
    private void getSlider() {
        ...
        if(currentGame.isSoccer()) {
            getWebRequestHelper().getSoccerSilder(this);
        }
    }
