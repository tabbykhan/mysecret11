package com.app.ui.main.soccer.dashboard.home.live.adapter;
 ...
 */
public class LiveSoccerMatchAdapter extends AppBaseRecycleAdapter {
    Context context;
    List<MatchModel> upcomingMatches;

    public LiveSoccerMatchAdapter(Context context, List<MatchModel> upcomingMatches) {
