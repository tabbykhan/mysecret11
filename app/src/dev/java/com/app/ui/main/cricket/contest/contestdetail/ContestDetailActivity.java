...
import com.app.ui.main.cricket.contest.contestdetail.adapter.ContestDetailAdapter;
...
public class ContestDetailActivity extends AppBaseActivity implements MatchTimerListener {
    ...
    private void initializeRecyclerView() {
        adapter = new ContestDetailAdapter(this, contestTeamModels) {
            @Override
            ...
            public UserModel getUserModel() {
                return ContestDetailActivity.this.getUserModel();
            }
...
//        });
    ...
    private void goToSwitchTeamActivity(Bundle bundle) {
        Intent intent = new Intent(this, SwitchTeamActivity.class);
        if (bundle != null) {
    ...
    private void getContestTeams() {
        if (getMatchModel() != null) {
            ...
            getWebRequestHelper().getContestTeams(getMatchModel().getMatch_id(),
    ...
    private void getContestDetail() {
        if (getMatchModel() != null) {
            getWebRequestHelper().getMatchContestDetail(getMatchContestId(),
    ...
    public void onWebRequestResponse(WebRequest webRequest) {
        if (webRequest.getWebRequestId() == ID_CONTEST_TEAMS) {
        ...
        switch (webRequest.getWebRequestId()) {
            case ID_CONTEST_TEAMS:
                handleContestTeamsResponse(webRequest);
                break;
            case ID_MATCH_CONTESTS_DETAIL:
