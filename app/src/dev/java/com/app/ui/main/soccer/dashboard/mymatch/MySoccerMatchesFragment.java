 ...
 */
public class MySoccerMatchesFragment extends AppBaseFragment implements MatchTimerListener {
    ...
    private void setupViewPager() {
        ...
        adapter.addFragment(new MySoccerFixtureFragment(), "FIXTURE");
        adapter.addFragment(new MySoccerLiveFragment(), "LIVE");
        adapter.addFragment(new MySoccerResultFragment(), "RESULT");
    ...
    public void onMatchTimeUpdate() {
        ...
        if (viewpager_match.getCurrentItem() == 0) {
            ...
            ((MySoccerFixtureFragment) item).onMatchTimeUpdate();
        }
    }
}
