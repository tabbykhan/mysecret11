package com.app.ui.main.cricket.dashboard.mymatches.result;
...
import com.app.ui.main.cricket.dashboard.mymatches.result.adapters.MyResultAdapter;
 ...
 */
public class MyResultFragment extends AppBaseFragment implements MatchTimerListener {
    ...
    private void initializeRecyclerView() {
        adapter = new MyResultAdapter(getActivity(), MyApplication.getInstance().getMyPastMatches()) {
            @Override
    ...
    private void getCustomerPastMatches() {
        ...
        updateViewVisibitity(ll_no_item, View.GONE);
        updateViewVisibitity(tv_no_item, View.GONE);
        getWebRequestHelper().getCustomerPastMatches(this);
    }
