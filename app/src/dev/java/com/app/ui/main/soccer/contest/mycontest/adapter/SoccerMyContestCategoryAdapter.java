package com.app.ui.main.soccer.contest.mycontest.adapter;
 ...
 */
public class SoccerMyContestCategoryAdapter extends AppBaseRecycleAdapter {
    Context context;
    List<ContestCategoryModel> list;

    public SoccerMyContestCategoryAdapter(Context context, List<ContestCategoryModel> list) {
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        SoccerMyContestAdapter myContestAdapter;
        ...
        public void setData(int position) {
            ...
            if (contestCategoryModel != null) {
                ...
                myContestAdapter = new SoccerMyContestAdapter(context,
                        contestCategoryModel.getContests()) {
                    @Override
                    public MatchModel getMatchModel() {
                        return SoccerMyContestCategoryAdapter.this.getMatchModel();
                    }
