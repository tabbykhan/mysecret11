package com.app.ui.main.soccer.soccermatchstate.adapter;
 ...
 */
public class SoccerMatchStatsAdapter extends AppBaseRecycleAdapter {

    Context context;
    List<PlayerStatsModel> list;

    public SoccerMatchStatsAdapter(Context context, List<PlayerStatsModel> list) {
