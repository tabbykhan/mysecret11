...
import com.app.ui.main.soccer.dialog.adapter.SoccerWinnerBreakupAdapter;
import com.base.BaseFragment;
import com.google.android.material.bottomsheet.BottomSheetBehavior;
import com.medy.retrofitwrapper.WebRequest;
import com.utilities.DeviceScreenUtil;

public class SoccerWinnerBreakupDialog extends AppBaseDialogFragment {
    ...
    SoccerWinnerBreakupAdapter adapter;
    ContestWinnerBreakUpModel contestWinnerBreakUpModel;

    public static SoccerWinnerBreakupDialog getInstance(Bundle bundle) {
        SoccerWinnerBreakupDialog winnerBreakupDialog = new SoccerWinnerBreakupDialog();
    ...
    private void initializeRecyclerView() {
        adapter = new SoccerWinnerBreakupAdapter(getActivity(), contestWinnerBreakUpModel);
    ...
    private void getWinnerBreakup() {
        ...
        getWebRequestHelper().getContestSoccerWinnerBreakUp(getContestId(), this);
    }
    ...
    public void onWebRequestResponse(WebRequest webRequest) {
        ...
        switch (webRequest.getWebRequestId()) {
            case ID_CONTEST_SOCCER_WINNER_BREAKUP:
