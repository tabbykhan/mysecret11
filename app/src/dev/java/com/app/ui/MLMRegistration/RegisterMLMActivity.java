package com.app.ui.MLMRegistration;
...
public class RegisterMLMActivity extends AppBaseActivity {
    ...
    private RadioGroup positionTxtGroup;
    private RadioGroup sponsorGroup;
    private RadioButton radioSponsorButton;
    private RadioButton radioSPositionButton;
    ...
    public int getLayoutResourceId() {
        return R.layout.activity_register_mlm;
    }
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case DialogInterface.BUTTON_POSITIVE:
                        dialog.dismiss();
                        MyApplication.getInstance().getFacebookLoginHandler().setSocialLoginListner(fbLoginListener);
                        MyApplication.getInstance().getFacebookLoginHandler().callLoginWithRead(RegisterMLMActivity.this,
                                Arrays.asList("email"));
                        break;
